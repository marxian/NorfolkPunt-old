...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Picture.attribution'
        db.add_column('localboats_picture', 'attribution', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='photographs', blank=True, to=orm['localboats.Person']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Picture.attribution'
        db.delete_column('localboats_picture', 'attribution_id')
