...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Boat.preferred_pic'
        db.add_column('localboats_boat', 'preferred_pic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localboats.Picture'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Boat.preferred_pic'
        db.delete_column('localboats_boat', 'preferred_pic_id')
