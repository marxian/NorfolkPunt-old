...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.postcode'
        db.delete_column('events_event', 'postcode')


    def backwards(self, orm):
        
        # Adding field 'Event.postcode'
        db.add_column('events_event', 'postcode', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)
