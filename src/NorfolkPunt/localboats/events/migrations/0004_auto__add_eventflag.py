...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventFlag'
        db.create_table('events_eventflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('events', ['EventFlag'])

        # Adding M2M table for field flags on 'Event'
        db.create_table('events_event_flags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['events.event'], null=False)),
            ('eventflag', models.ForeignKey(orm['events.eventflag'], null=False))
        ))
        db.create_unique('events_event_flags', ['event_id', 'eventflag_id'])

    def backwards(self, orm):
        # Deleting model 'EventFlag'
        db.delete_table('events_eventflag')

        # Removing M2M table for field flags on 'Event'
        db.delete_table('events_event_flags')
    ...
    models = {
        'events.event': {
            ...
            'flags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'events'", 'symmetrical': 'False', 'to': "orm['events.EventFlag']"}),
