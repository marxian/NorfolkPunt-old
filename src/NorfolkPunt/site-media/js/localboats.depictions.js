...
(function($){
    ...
    $.fn.localboatsDepictions = function(settings){
	...
	var _stopLoading = function(pointer) {
        ...
        var _getNotes = function(pointer){
            ...
            var depictions = $(settings.datasource);
            $.each(depictions, function(){
                _printNote(pointer, $(this).data('depiction'));
                
                //Make our links more interactive
                $(this).hover(function(){
