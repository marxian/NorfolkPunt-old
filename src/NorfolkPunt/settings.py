# Django settings for NorfolkPunt project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.normpath(os.path.join(PROJECT_ROOT, '..', 'sqlite.db')),                      # Or path to database file if using sqlite3.
